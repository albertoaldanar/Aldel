...
function SuccessSignupClient(props) {
    console.log(props);
    ...
    return(
        <View style = {styles.container}>
            ...
            <Text style = {{marginTop: 60,  fontWeight: "300", textAlign: "center", fontSize: 15, letterSpacing: 4, marginLeft: 10, marginRight: 10}}>Ahora puedes interactuar con tus usuarios favoritos</Text>
...
export default SuccessSignupClient;
