...
import { View, Text, StyleSheet, Platform, Image, ScrollView, TouchableOpacity, TextInput } from "react-native";
            ...
            <View style = {styles.container}>
                ...
                <ScrollView>
                    <View style = {styles.profileHeader}> 
                        ...
                        <View style = {{marginTop: 10}}>
                            <View style = {{flexDirection: "row"}}>
                                ...
                                {
                                    adminData.verified === 2 ? 
                                        <Image source = {VerifiedIcon} style = {{height: 30, width: 30, marginLeft: 10, marginTop: -3}}/>
                                    : null
                                }
                            </View>
                    ...
                    <View style = {styles.profileSection}>
                        ...
                        <TouchableOpacity style = {styles.sectionCard}  onPress = {() => props.navigation.navigate('ConsultorVideo')}>
                    ...
                    <View style = {styles.profileSection}>
                        <Text style = {{color: "gray", fontSize: 13, marginBottom: 10}}>Atención a clientes</Text>

                        <TouchableOpacity style = {styles.sectionCard} onPress = {() => props.navigation.navigate("ConsultorQuestions")}>
                            <Icon name="question-circle" size={20} color="gray"/>
                            <Text style = {styles.sectionTitle}>Formulario para interacción</Text>
                        </TouchableOpacity> 
                    </View> 

                    <View style = {styles.profileSection}>
                        <Text style = {{color: "gray", fontSize: 13, marginBottom: 10}}>Canales</Text>

                        <TouchableOpacity style = {styles.sectionCard} onPress = {() => props.navigation.navigate("ChannelSetup")}>
                            <Icon name="phone" size={20} color="gray"/>
                            <Text style = {styles.sectionTitle}>Habilitar canales</Text>
                        </TouchableOpacity> 

                        <TouchableOpacity style = {styles.sectionCard} onPress = {() => props.navigation.navigate("ChannelPrices")}>
                            <Icon name="money" size={20} color="gray"/>
                            <Text style = {styles.sectionTitle}>Precios canales</Text>
                        </TouchableOpacity> 
                    </View> 

                    <View style = {styles.profileSection}>
                        <Text style = {{color: "gray", fontSize: 13, marginBottom: 10}}>Cuenta</Text>

                        <TouchableOpacity style = {styles.sectionCard} onPress = {() => props.navigation.navigate("VerifyAccount")}>
                            <Icon name="check-circle" size={20} color="gray"/>
                            <Text style = {styles.sectionTitle}>Verificar cuenta</Text>
                        </TouchableOpacity> 
                    </View> 

                    {/* <View style = {styles.profileSection}>
                        <Text style = {{color: "gray", fontSize: 13, marginBottom: 10}}>Documentación</Text>

                        <TouchableOpacity style = {styles.sectionCard}>
                            <Icon name="file" size={20} color="gray"/>
